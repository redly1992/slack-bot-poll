...
<!-- KEY INSIGHT: Strategy is unprofitable (-$1.39) with low win rate (33.3%), needs aggressive filtering -->
...
1. **Win Rate**: 33.3% (81 wins, 162 losses) - UNPROFITABLE SYSTEM
2. **Total P&L**: -$1.39 - NEEDS AGGRESSIVE FILTERING
