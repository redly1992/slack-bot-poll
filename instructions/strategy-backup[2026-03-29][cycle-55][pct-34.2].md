...
<!-- KEY INSIGHT: Strategy is losing ($-32.52) with low win rate (31.7%), needs aggressive filtering -->
...
1. **Win Rate**: 31.7% (77 wins, 166 losses) - LOSING SYSTEM
2. **Total P&L**: $-32.52 - UNPROFITABLE, NEEDS AGGRESSIVE FILTERING
