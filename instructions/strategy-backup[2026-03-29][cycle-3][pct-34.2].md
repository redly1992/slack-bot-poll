...
<!-- KEY INSIGHT: Strategy is barely profitable (+$103.09) with low win rate (34.6%), needs aggressive filtering -->
...
1. **Win Rate**: 34.6% (84 wins, 159 losses) - LOW WIN RATE, MARGINAL PROFIT
2. **Total P&L**: +$103.09 - NEEDS AGGRESSIVE FILTERING
