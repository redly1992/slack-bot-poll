...
<!-- Based on 243 signals: 77 wins / 166 losses (31.7% win rate) -->

<!-- AI-IMPROVED: 2026-03-29 -->
<!-- Based on 243 trades: 77 wins / 166 losses (31.7% win rate) -->
<!-- DATA-DRIVEN UPDATE: 2026-03-29 - Detailed analysis of 30 sample trades (15 wins, 15 losses) -->
<!-- KEY INSIGHT: Strategy is losing ($-64.65) with very low win rate (31.7%), needs aggressive filtering -->
...
1. **Win Rate**: 31.7% (77 wins, 166 losses) - VERY LOW WIN RATE SYSTEM
2. **Total P&L**: $-64.65 - LOSING STRATEGY, NEEDS AGGRESSIVE FILTERING
3. **Critical Problem**: Too many low-quality trades, especially against market structure
4. **Performance Patterns Identified**:
   - **Winning Pattern**: LONG in BULLISH markets with 15m EMA bullish alignment (fast > slow) - 53% of winning trades
   - **Winning Pattern**: SHORT in BULLISH markets with 15m EMA bearish alignment (fast < slow) - 33% of winning trades
   - **Winning Pattern**: SHORT in BEARISH markets with 15m EMA bearish alignment - 13% of winning trades
   - **Losing Pattern**: SHORT in BULLISH markets with 15m EMA bullish alignment (contradiction) - 47% of losing trades
   - **Losing Pattern**: LONG when 4h MACD_hist > 200 (exhaustion) - 20% of losing trades
...
6. **MARKET CONDITION SPECIFIC RULES**:
   - **BULLISH MARKET (4h bullish)**:
     - PREFER LONG trades (53% of winning trades)
     - ALLOW SHORT only with 15m bearish EMA alignment (33% of winning trades)
     - AVOID LONG when 4h MACD_hist > 200 (20% of losing trades)
...
- **DATA RULE**: PREFER LONG in bullish markets (53% of winning trades)
