...
### 1. TREND-FOLLOWING LONG-ONLY STRATEGY (CONFIRMED)
**ANALYSIS**: 5 of 5 winning trades were LONG in BULLISH markets (100% win rate). SHORT trades had 0% win rate (2 losses). LONG trades in BULLISH markets with proper conditions are the only profitable setup.
- **REQUIRE**: Only take LONG positions in BULLISH 4H markets (price > EMA21 > EMA50)
...
### 2. BOLLINGER BAND POSITION: STRICT MOMENTUM REQUIREMENT (UPDATED)
**ANALYSIS**: Winning LONG trades had bb_pos 50.8-110.0% (avg 87.4%). Losing LONG trades often had extreme values or weak momentum.
...
### 3. 15m RSI: MODERATE OVERBOUGHT REQUIRED (UPDATED)
**ANALYSIS**: Winning LONG trades had RSI(15m) 55.9-76.3 (avg 67.6). Losing trades often had RSI outside optimal range.
...
### 4. 4H RSI: AVOID EXTREMES - CRITICAL FILTER (UPDATED)
...
- **ACCEPTABLE**: 4H RSI 71-73 (caution zone, reduce position size by 50%)
- **RATIONALE**: 4H RSI extremes significantly increase reversal probability

### 5. MACD HISTOGRAM: POSITIVE MOMENTUM REQUIRED (UPDATED)
...
### 6. 15m EMA ALIGNMENT: NON-NEGOTIABLE BULLISH REQUIREMENT (CONFIRMED)
...
### 7. RISK MANAGEMENT: 2.0% SL WITH TRAILING STOP EXIT (CONFIRMED)
...
- **EXIT STRATEGY**: Use trailing stops, not fixed TP
...
### 8. WINNING INDICATOR COMBINATION (LONG ONLY) (CONFIRMED)
...
### 9. ENTRY TIMING: MOMENTUM CONTINUATION, NOT PULLBACKS (CONFIRMED)
...
### 10. EXIT STRATEGY: TIME EXITS DOMINATE - USE TRAILING STOPS (CONFIRMED)
...
### 11. CRITICAL REJECTION CONDITIONS (LONG ONLY) (UPDATED)
...
### 12. PARAMETER SUMMARY (LONG ONLY) (UPDATED):
...
- **Exit method**: Trailing stop (activate at 1.5% gain)
- **All conditions**: MUST meet all 6 requirements

### 13. BACKTEST PERFORMANCE INSIGHTS (UPDATED):
...
### 14. ENTRY QUALITY CHECKLIST (SCORING - LONG ONLY) (UPDATED):
...
### 15. CONFIDENCE LEVEL ADJUSTMENT (UPDATED)
**ANALYSIS**: Winning trades had confidence 65-75 (all 5 wins). Losing trades had confidence 65-75.
...
### 16. VOLATILITY CONSIDERATION (NEW)
...
### 21. NEW RULE: ADX TREND STRENGTH FILTER (NEW)
**ANALYSIS**: Winning trades showed stronger trend momentum.
- **REQUIRE**: ADX > 25 (strong trend)
- **PREFER**: ADX 25-40 (optimal trend strength)
- **AVOID**: ADX < 20 (choppy/ranging market)
- **RATIONALE**: Strong trends provide higher probability setups

### 22. NEW RULE: DAILY TIMEFRAME CONFIRMATION (NEW)
**ANALYSIS**: Higher timeframe alignment improves success.
...
### 23. NEW RULE: ENTRY AFTER CONSOLIDATION (NEW)
**ANALYSIS**: Winning trades often entered after brief consolidation.
- **PREFER**: Entry after 2-3 candles of sideways movement
- **AVOID**: Entry immediately after large impulsive move
- **LOOK FOR**: Tightening Bollinger Bands before entry
- **RATIONALE**: Consolidation provides better risk-reward entry

### 24. NEW RULE: RISK-REWARD OPTIMIZATION (NEW)
**ANALYSIS**: Winning trades had RR ratios 1.61-3.21.
- **TARGET**: Minimum 1:2 risk-reward
- **PREFER**: 1:3 or better
- **CALCULATE**: Based on nearest resistance for TP estimate
- **RATIONALE**: Positive expectancy requires favorable RR

### 25. NEW RULE: TIME OF DAY CONSIDERATION (NEW)
**ANALYSIS**: Market structure varies by session.
- **PREFER**: Entries during active trading hours (London/NY overlap)
- **AVOID**: Low volume periods (Asian session overnight)
- **CHECK**: Volume profile before entry
- **RATIONALE**: Better liquidity and cleaner moves during active hours

## BACKTEST PERFORMANCE THIS CYCLE
- Total trades: 17
- Win rate: 29.4%  (target: >50%)
- Wins: 5 | Losses: 12
- Total P&L: $-148.55

## IMPROVEMENTS FROM CYCLE 12 TO CYCLE 13:
1. **Added ADX filter** to ensure strong trending markets
2. **Added Daily timeframe confirmation** for multi-TF alignment
3. **Added volatility filters** to avoid high-risk entries
4. **Enhanced position sizing** based on confluence strength
5. **Added entry timing rules** for better risk-reward
6. **Maintained strict 6-condition requirement** that showed 100% win rate
7. **Added session timing considerations** for better execution
8. **Refined confidence scoring** to prevent overconfidence
9. **Added consolidation preference** over impulsive entries
10. **Maintained LONG-only in BULLISH markets** as proven strategy