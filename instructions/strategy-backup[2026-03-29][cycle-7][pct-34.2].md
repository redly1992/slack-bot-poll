...
<!-- KEY INSIGHT: Strategy is barely profitable (+$100.25) with low win rate (33.3%), needs aggressive filtering -->
...
1. **Win Rate**: 33.3% (81 wins, 162 losses) - LOW WIN RATE, MARGINAL PROFIT
2. **Total P&L**: +$100.25 - NEEDS AGGRESSIVE FILTERING
