...
### 1. TREND-FOLLOWING LONG-ONLY STRATEGY
...
### 2. BOLLINGER BAND POSITION: STRICT MOMENTUM REQUIREMENT
...
### 3. 15m RSI: MODERATE OVERBOUGHT REQUIRED
...
- **ACCEPTABLE**: 4H RSI 71-73 (caution zone, reduce position size)
- **RATIONALE**: 4H RSI extremes significantly increase reversal probability

### 5. MACD HISTOGRAM: POSITIVE MOMENTUM REQUIRED
...
### 7. RISK MANAGEMENT: 2.0% SL WITH TRAILING STOP EXIT
