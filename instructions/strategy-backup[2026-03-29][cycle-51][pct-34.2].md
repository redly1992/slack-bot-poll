...
<!-- KEY INSIGHT: Strategy is barely profitable ($9.49) with low win rate (33.7%), needs aggressive filtering -->
...
1. **Win Rate**: 33.7% (82 wins, 161 losses) - LOW WIN RATE SYSTEM
2. **Total P&L**: $9.49 - MARGINALLY PROFITABLE, NEEDS AGGRESSIVE FILTERING
