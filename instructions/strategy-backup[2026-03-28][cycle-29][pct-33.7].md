...
<!-- KEY INSIGHT: Strategy is barely profitable ($108.31) with low win rate (34.6%), indicating poor entry filtering -->
...
1. **Win Rate**: 34.6% (84 wins, 159 losses) - low but profitable due to higher average win size
2. **Total P&L**: $108.31 (needs significant improvement in win rate)
