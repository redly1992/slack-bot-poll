...
<!-- KEY INSIGHT: Strategy is barely profitable (+$21.68) with low win rate (32.1%), needs aggressive filtering -->
...
1. **Win Rate**: 32.1% (78 wins, 165 losses) - LOW WIN RATE, MARGINAL PROFIT
2. **Total P&L**: +$21.68 - NEEDS AGGRESSIVE FILTERING
