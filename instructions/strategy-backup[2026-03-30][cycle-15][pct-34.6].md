...
<!-- KEY INSIGHT: Strategy is barely profitable ($115.50) with low win rate (35.4%), needs aggressive filtering -->
...
1. **Win Rate**: 35.4% (86 wins, 157 losses) - LOW WIN RATE, NEEDS AGGRESSIVE FILTERING
2. **Total P&L**: $115.50 - BARELY PROFITABLE, NEEDS OPTIMIZATION
