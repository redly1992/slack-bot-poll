...
- **REQUIRE FOR LONG**: bb_pos between 25% and 35% (optimal: 28-32%)
- **REQUIRE FOR SHORT**: bb_pos between 65% and 75% (optimal: 68-72%)
...
- **REQUIRE FOR LONG**: RSI(15m) between 38 and 42 (optimal: 39-41)
- **REQUIRE FOR SHORT**: RSI(15m) between 58 and 62 (optimal: 59-61)
...
- **REQUIRE FOR LONG**: Stochastic %K between 35 and 45 (optimal: 38-42)
- **REQUIRE FOR SHORT**: Stochastic %K between 55 and 65 (optimal: 58-62)
...
- **REQUIRE FOR LONG**: MACD hist > -25 and showing improvement (less negative or turning positive)
- **REQUIRE FOR SHORT**: MACD hist < 25 and showing deterioration (less positive or turning negative)
- **REJECT**: MACD hist < -40 or > 40 (extreme momentum - DO NOT TRADE)
...
- **OPTIMAL SL distance**: 2.8-3.2% (adjusted from 2.5-3.5%)
- **MINIMUM SL distance**: 2.5% (increased from 2.0%)
- **MAXIMUM SL distance**: 3.5%
- **REQUIRE**: SL distance ≥ 2.5% for confidence ≥ 85
...
- **OPTIMAL TP distance**: 6.0-8.0% (adjusted from 5.0-7.0%)
- **MINIMUM R:R ratio**: 1:3.0 (increased from 1:2.5)
- **PREFER R:R ratio**: 1:3.5 to 1:4.5
- **REQUIRE**: R:R ≥ 1:3.0 for confidence ≥ 85
...
- **MINIMUM EXECUTION CONFIDENCE**: 90 (adjusted from 85)
...
3. bb_pos in optimal range (25-35% LONG, 65-75% SHORT)
4. RSI(15m) in optimal range (38-42 LONG, 58-62 SHORT)
5. MACD hist in optimal range (> -25 LONG, < 25 SHORT) and improving
...
### 10. ENTRY CHECKLIST - STRICT VERSION (CYCLE 21)
...
2. ✅ 15m EMA alignment MATCHING direction (bullish for LONG, bearish for SHORT) - MANDATORY
3. ✅ bb_pos in optimal range (25-35% for LONG, 65-75% for SHORT)
4. ✅ RSI(15m) in optimal range (38-42 for LONG, 58-62 for SHORT)
5. ✅ MACD hist in optimal range (> -25 for LONG, < 25 for SHORT) and improving
6. ✅ Stochastic %K in optimal range (35-45 for LONG, 55-65 for SHORT) and turning
7. ✅ SL distance 2.5-3.5%
8. ✅ TP distance 6.0-8.0%
9. ✅ R:R ratio ≥ 1:3.0
10. ✅ Confidence ≥ 90
...
- **High volatility (ATR > 3.5%)**: Use wider SL (3.0-3.5%), larger TP (7.0-8.0%)
- **Normal volatility (ATR 2.0-3.5%)**: Use standard SL (2.8-3.2%), TP (6.0-7.0%)
- **Low volatility (ATR < 2.0%)**: Use tighter SL (2.5-3.0%), smaller TP (5.5-6.5%)
...
- **Full exit**: At 6.0% profit or if momentum reverses

### 14. RISK MANAGEMENT (ENHANCED)
**Stricter rules after 3 losses in last 3 trades:**
- **Position size**: 0.05% of portfolio per trade (adjusted from 0.05-0.10%)
- **Maximum daily loss**: 0.15% of portfolio (adjusted from 0.2%)
- **Stop loss placement**: Below/above structure + 2.5% minimum buffer
- **Take profit**: Primary at 6.0%, secondary at 3.0% with trail
...
4. **Tighten parameter ranges** (RSI 39-41 for LONG, 59-61 for SHORT)
...
- **AVOID**: Extreme MACD hist (<-25 or >25) (all 3 losses had this)
- **AVOID**: SL distance < 2.5% (all 3 losses had this)
- **AVOID**: Confidence < 90 (all 3 losses were <90 confidence)

### 18. OPTIMAL PARAMETER RANGES (PRECISE)
**Based on backtest analysis and adjustments:**
- **SL distance**: 3.0% optimal (range: 2.8-3.2%)
- **TP distance**: 7.0% optimal (range: 6.0-8.0%)
- **R:R ratio**: 1:3.5 optimal (range: 1:3.0-1:4.5)
- **bb_pos LONG**: 30% optimal (range: 28-32%)
- **bb_pos SHORT**: 70% optimal (range: 68-72%)
- **RSI(15m) LONG**: 40 optimal (range: 39-41)
- **RSI(15m) SHORT**: 60 optimal (range: 59-61)
- **Stochastic LONG**: 40 optimal (range: 38-42)
- **Stochastic SHORT**: 60 optimal (range: 58-62)
- **MACD hist LONG**: > -15 optimal (range: > -25)
- **MACD hist SHORT**: < 15 optimal (range: < 25)
...
2. ✅ bb_pos in optimal range (25-35% LONG, 65-75% SHORT)
3. ✅ RSI(15m) in optimal range (38-42 LONG, 58-62 SHORT)
4. ✅ Stochastic in optimal range (35-45 LONG, 55-65 SHORT) and turning
5. ✅ MACD hist in optimal range (> -25 LONG, < 25 SHORT) and improving
6. ✅ SL distance 2.5-3.5%
7. ✅ TP distance 6.0-8.0%
8. ✅ R:R ratio ≥ 1:3.0
9. ✅ Confidence ≥ 90
...
- bb_pos: 28-32% (moderate oversold, not extreme)
- RSI(15m): 39-41 (moderate oversold)
...
- bb_pos: 68-72% (moderate overbought, not extreme)
- RSI(15m): 59-61 (moderate overbought)
...
### 21. REMOVED/REPLACED RULES FROM CYCLE 20
**Replaced these Cycle 20 rules:**
- ❌ "SL distance: 2.5-3.5%" → **REPLACED WITH** "SL distance: 2.8-3.2%"
- ❌ "TP distance: 5.0-7.0%" → **REPLACED WITH** "TP distance: 6.0-8.0%"
- ❌ "R:R ratio ≥ 1:2.5" → **REPLACED WITH** "R:R ratio ≥ 1:3.0"
- ❌ "bb_pos: 20-40% LONG, 60-80% SHORT" → **REPLACED WITH** "bb_pos: 25-35% LONG, 65-75% SHORT"
- ❌ "RSI(15m): 35-45 LONG, 55-65 SHORT" → **REPLACED WITH** "RSI(15m): 38-42 LONG, 58-62 SHORT"
- ❌ "Stochastic: 30-50 LONG, 50-70 SHORT" → **REPLACED WITH** "Stochastic: 35-45 LONG, 55-65 SHORT"
- ❌ "MACD hist: > -50 LONG, < 50 SHORT" → **REPLACED WITH** "MACD hist: > -25 LONG, < 25 SHORT"
- ❌ "Confidence threshold: 85+" → **REPLACED WITH** "Confidence threshold: 90+"

**Enhanced these Cycle 20 rules:**
...
### 22. NEW RULES FOR CYCLE 21 (BASED ON 3 LOSSES ANALYSIS)
**Added these new rules:**

1. **Tighter MACD Histogram Momentum Requirement**
   - All 3 losing trades had extreme MACD hist values (-57.36, -161.34, 152.65)
   - New range: > -25 for LONG, < 25 for SHORT
   - Extreme momentum indicates continuation, not reversal

2. **Higher R:R Ratio Requirement (1:3.0 minimum)**
   - With 0% win rate, need higher compensation for losses
   - Previous 1:2.5 insufficient given current performance
   - Target 1:3.5 optimal for profitability

3. **Higher Confidence Threshold (90+)**
   - 40 and 45 confidence trades were clear losers
   - 85 confidence trade lost due to rule violations
   - Set higher threshold to filter out marginal setups

4. **Minimum SL Distance 2.5%**
   - All losing trades had SL < 2.0%
   - Need more buffer against market noise
   - 2.5% minimum provides better protection

5. **Stricter Indicator Confluence (7/8 factors)**
   - Previous 6/7 allowed too many marginal setups
   - Require 7 out of 8 confirming factors
   - Ensures higher quality entries
...
- **Position size**: 0.05% of portfolio per trade (reduced)
...
3. **Check bb_pos** (must be 25-35% LONG, 65-75% SHORT - if not, STOP)
4. **Check RSI(15m)** (must be 38-42 LONG, 58-62 SHORT - if not, STOP)
5. **Check Stochastic** (must be 35-45 LONG, 55-65 SHORT and turning - if not, STOP)
6. **Check MACD hist** (must be > -25 LONG, < 25 SHORT and improving - if not, STOP)
7. **Calculate SL/TP distances** (must be in optimal ranges)
8. **Calculate R:R ratio** (must be ≥ 1:3.0)
