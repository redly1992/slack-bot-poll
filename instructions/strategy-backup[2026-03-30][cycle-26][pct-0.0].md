<!-- AI-IMPROVED: 2026-03-30 | Cycle 25 -->
...
### 2. EXTREME INDICATOR VALUES ARE TRAP SETUPS (STRICT)
**ANALYSIS**: All 3 losing trades had extreme indicator values indicating momentum continuation, not reversal.
- **REQUIRE FOR LONG**: RSI(15m) between 38 and 45 (optimal: 40-43) - NOT below 35
- **REQUIRE FOR SHORT**: RSI(15m) between 55 and 62 (optimal: 57-60) - NOT above 65
- **REQUIRE FOR LONG**: Stochastic %K between 30 and 40 (optimal: 32-38) - NOT below 25
- **REQUIRE FOR SHORT**: Stochastic %K between 60 and 70 (optimal: 62-68) - NOT above 75
- **REQUIRE FOR LONG**: MACD hist > -30 and improving (NOT < -40)
- **REQUIRE FOR SHORT**: MACD hist < 30 and deteriorating (NOT > 40)
- **REQUIRE FOR LONG**: bb_pos between 35% and 45% (optimal: 38-42%) - NOT below 30%
- **REQUIRE FOR SHORT**: bb_pos between 55% and 65% (optimal: 58-62%) - NOT above 70%
- **REJECT ALL EXTREMES**: Extreme values indicate momentum continuation, not reversal

### 3. STOP LOSS DISTANCE OPTIMIZATION (PRECISE)
**ANALYSIS**: All losing trades had SL distances below 2.0% (1.75%, 2.04%, 1.80%) and were stopped by noise.
- **OPTIMAL SL distance**: 2.2-2.8% (adjusted from 2.0-2.5%)
- **MINIMUM SL distance**: 2.0% (increased from 1.8%)
- **MAXIMUM SL distance**: 3.0%
- **REQUIRE**: SL distance ≥ 2.2% for confidence ≥ 85
- **RATIONALE**: Crypto volatility requires 2.0%+ buffer to avoid noise stops

### 4. TAKE PROFIT REALISTIC TARGETS (OPTIMIZED)
**ANALYSIS**: Losing trades had TP distances: 4.03%, 4.39%, 4.41% with R:R ratios: 2.30, 2.15, 2.45.
- **OPTIMAL TP distance**: 4.5-5.5% (adjusted from 4.0-6.0%)
- **MINIMUM R:R ratio**: 1:2.0 (maintained)
- **PREFER R:R ratio**: 1:2.2 to 1:2.8
- **REQUIRE**: R:R ≥ 1:2.2 for confidence ≥ 85
...
6. ✅ Stochastic %K in optimal range (30-40 LONG, 60-70 SHORT) and turning
- **REQUIRE**: ALL 6 factors must confirm for confidence ≥ 90
...
- **REQUIRE FOR LONG**: bb_pos between 35% and 45% (optimal: 38-42%)
- **REQUIRE FOR SHORT**: bb_pos between 55% and 65% (optimal: 58-62%)
- **REJECT**: bb_pos < 30% or > 70% (extreme exhaustion - DO NOT TRADE)
...
### 9. ENTRY CHECKLIST - STRICT VERSION (CYCLE 25)
...
6. ✅ Stochastic %K in optimal range (30-40 for LONG, 60-70 for SHORT) and turning
7. ✅ SL distance 2.0-3.0%
...
- **High volatility (ATR > 3.5%)**: Use wider SL (2.5-3.0%), larger TP (5.0-5.5%)
- **Normal volatility (ATR 2.0-3.5%)**: Use standard SL (2.2-2.8%), TP (4.5-5.0%)
...
- **Scale out**: Take 50% profit at 2.2%, trail stop on remainder
- **Move to breakeven**: After 1.8% profit, move SL to entry + 0.5%
...
- **Maximum daily loss**: 0.10% of portfolio (reduced from 0.15%)
- **Stop loss placement**: Below/above structure + 2.0% minimum buffer
- **Take profit**: Primary at 4.5%, secondary at 2.2% with trail
...
4. **Tighten parameter ranges** (RSI 40-43 for LONG, 57-60 for SHORT)
...
- **AVOID**: Extreme bb_pos (<35% or >65%) (all 3 losses had extreme values)
...
- **TP distance**: 4.8% optimal (range: 4.5-5.2%)
- **R:R ratio**: 1:2.4 optimal (range: 1:2.2-1:2.8)
- **bb_pos LONG**: 40% optimal (range: 38-42%)
- **bb_pos SHORT**: 60% optimal (range: 58-62%)
- **RSI(15m) LONG**: 42 optimal (range: 40-44)
- **RSI(15m) SHORT**: 59 optimal (range: 57-61)
- **Stochastic LONG**: 35 optimal (range: 32-38)
- **Stochastic SHORT**: 65 optimal (range: 62-68)
...
4. ✅ Stochastic in optimal range (30-40 LONG, 60-70 SHORT) and turning
5. ✅ MACD hist in optimal range (> -30 LONG, < 30 SHORT) and improving
6. ✅ SL distance 2.0-3.0%
...
- bb_pos: 38-42% (moderate oversold, not extreme)
- RSI(15m): 40-44 (moderate oversold, NOT extreme)
- Stochastic: 32-38 and rising
...
- bb_pos: 58-62% (moderate overbought, not extreme)
- RSI(15m): 57-61 (moderate overbought, NOT extreme)
- Stochastic: 62-68 and falling
...
### 20. REMOVED/REPLACED RULES FROM CYCLE 24
**Replaced these Cycle 24 rules:**
- ❌ "SL distance: 2.0-2.5%" → **REPLACED WITH** "SL distance: 2.2-2.8%"
- ❌ "TP distance: 4.0-6.0%" → **REPLACED WITH** "TP distance: 4.5-5.5%"
- ❌ "R:R ratio ≥ 1:2.0" → **REPLACED WITH** "R:R ratio ≥ 1:2.2"
- ❌ "bb_pos: 30-40% LONG, 60-70% SHORT" → **REPLACED WITH** "bb_pos: 35-45% LONG, 55-65% SHORT"
- ❌ "RSI(15m): 35-45 LONG, 55-65 SHORT" → **REPLACED WITH** "RSI(15m): 38-45 LONG, 55-62 SHORT"
- ❌ "Stochastic: 25-40 LONG, 60-75 SHORT" → **REPLACED WITH** "Stochastic: 30-40 LONG, 60-70 SHORT"
- ❌ "MACD hist: > -40 LONG, < 40 SHORT" → **REPLACED WITH** "MACD hist: > -30 LONG, < 30 SHORT"
- ❌ "Confidence threshold: 85+" → **REPLACED WITH** "Confidence threshold: 90+"

**Enhanced these Cycle 24 rules:**
...
### 21. NEW RULES FOR CYCLE 25 (BASED ON 3 LOSSES ANALYSIS)
...
2. **MINIMUM SL DISTANCE 2.0% (INCREASED)**
   - All losing trades had SL < 2.0% (1.75%, 2.04%, 1.80%)
   - Crypto volatility requires 2.0%+ buffer
   - Prevents noise-based stop outs

3. **CONFIDENCE THRESHOLD 90+ (INCREASED)**
   - 40 and 45 confidence trades were clear losers
   - 85 confidence trade still lost due to rule violations
   - 90+ threshold ensures only highest quality setups
...
- **TP distance**: 4.8% optimal (range: 4.5-5.2%)
- **R:R ratio**: 1:2.4 optimal (range: 1:2.2-1:2.8)
- **Confidence threshold**: 90+ to execute (increased)
- **Position size**: 0.05% of portfolio per trade (maintained)
...
3. **Check bb_pos** (must be 35-45% LONG, 55-65% SHORT - if not, STOP)
4. **Check RSI(15m)** (must be 38-45 LONG, 55-62 SHORT - if not, STOP)
5. **Check Stochastic** (must be 30-40 LONG, 60-70 SHORT and turning - if not, STOP)
6. **Check MACD hist** (must be > -30 LONG, < 30 SHORT and improving - if not, STOP)
...
### 25. KEY INSIGHTS FROM LOSS ANALYSIS (CYCLE 25)
