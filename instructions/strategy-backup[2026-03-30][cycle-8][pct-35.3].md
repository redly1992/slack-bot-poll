...
### 1. TREND-FOLLOWING ONLY - NO COUNTER-TREND TRADES
...
### 2. BOLLINGER BAND POSITION: STRICT MOMENTUM FILTER
...
### 3. 15m RSI: CRITICAL MOMENTUM ZONE
...
### 4. 4H RSI: PRIMARY REVERSAL FILTER
...
### 5. MACD HISTOGRAM: DIRECTIONAL CONFIRMATION
...
### 7. RISK MANAGEMENT: OPTIMAL SL/TP DISTANCES
...
### 8. WINNING INDICATOR COMBINATION
**ANALYSIS**: Winning trades consistently showed 3+ of these conditions:
...
### 9. ENTRY TIMING: PREFER PULLBACKS/RALLIES
...
### 10. EXIT STRATEGY: ADAPT TO MARKET
...
**Entry Decision:**
- **REJECT**: Score < 4
- **LOW CONFIDENCE**: Score 4 (confidence 60-69)
- **MEDIUM CONFIDENCE**: Score 5 (confidence 70-79)
- **HIGH CONFIDENCE**: Score 6 (confidence 80-89)
