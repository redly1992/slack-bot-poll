...
<!-- KEY INSIGHT: Strategy is barely profitable ($6.40) with low win rate (33.3%), needs aggressive filtering -->
...
1. **Win Rate**: 33.3% (81 wins, 162 losses) - LOW WIN RATE SYSTEM
2. **Total P&L**: $6.40 - BARELY PROFITABLE, NEEDS AGGRESSIVE FILTERING
