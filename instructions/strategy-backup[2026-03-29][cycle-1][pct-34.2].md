...
<!-- KEY INSIGHT: Strategy is barely profitable (+$48.41) with low win rate (34.6%), needs aggressive filtering -->
...
1. **Win Rate**: 34.6% (84 wins, 159 losses) - LOW WIN RATE, BARELY PROFITABLE
2. **Total P&L**: +$48.41 - MARGINAL PROFIT, NEEDS AGGRESSIVE FILTERING
