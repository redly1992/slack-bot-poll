...
<!-- KEY INSIGHT: Strategy is profitable ($119.92) but has low win rate (35.0%), indicating need for better entry filtering -->
...
1. **Win Rate**: 35.0% (85 wins, 158 losses) - profitable but needs improvement
2. **Total P&L**: $119.92 - positive but could be optimized
