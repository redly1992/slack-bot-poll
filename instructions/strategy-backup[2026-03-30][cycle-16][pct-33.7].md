...
<!-- KEY INSIGHT: Strategy is barely profitable ($117.57) with low win rate (34.6%), needs aggressive filtering -->
...
1. **Win Rate**: 34.6% (84 wins, 159 losses) - LOW WIN RATE, NEEDS AGGRESSIVE FILTERING
2. **Total P&L**: $117.57 - BARELY PROFITABLE, NEEDS OPTIMIZATION
