...
<!-- KEY INSIGHT: Strategy is losing ($-67.60) with low win rate (32.9%), needs aggressive filtering -->
...
1. **Win Rate**: 32.9% (80 wins, 163 losses) - LOSING SYSTEM
2. **Total P&L**: $-67.60 - UNPROFITABLE, NEEDS AGGRESSIVE FILTERING
