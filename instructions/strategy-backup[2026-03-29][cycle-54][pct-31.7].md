...
<!-- KEY INSIGHT: Strategy is losing ($-54.35) with low win rate (32.1%), needs aggressive filtering -->
...
1. **Win Rate**: 32.1% (78 wins, 165 losses) - LOSING SYSTEM
2. **Total P&L**: $-54.35 - UNPROFITABLE, NEEDS AGGRESSIVE FILTERING
