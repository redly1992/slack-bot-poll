...
<!-- KEY INSIGHT: Strategy is losing (-$36.09) with low win rate (32.1%), needs aggressive filtering -->
...
1. **Win Rate**: 32.1% (78 wins, 165 losses) - UNPROFITABLE, NEEDS AGGRESSIVE FILTERING
2. **Total P&L**: -$36.09 - STRATEGY IS LOSING MONEY
