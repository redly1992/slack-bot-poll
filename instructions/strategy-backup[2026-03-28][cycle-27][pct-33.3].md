...
<!-- KEY INSIGHT: Strategy is unprofitable (-$2.27) with very low win rate (32.1%), indicating poor entry filtering -->
...
1. **Win Rate**: 32.1% (78 wins, 165 losses) - very low, unprofitable
2. **Total P&L**: -$2.27 (needs significant improvement)
