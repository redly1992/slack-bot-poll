...
<!-- KEY INSIGHT: Strategy is losing ($-11.36) with low win rate (33.7%), indicating critical flaws in entry logic -->
...
1. **Win Rate**: 33.7% (82 wins, 161 losses) - UNPROFITABLE, needs major improvement
2. **Total P&L**: $-11.36 - LOSING STRATEGY, requires critical fixes
