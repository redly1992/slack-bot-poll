...
1. **Win Rate**: 33.3% (81 wins, 162 losses) - low win rate but positive P&L
2. **Total P&L**: $61.28 (positive despite low win rate)
...
4. **Performance Patterns Identified**:
   - **LONG trades in BULLISH markets**: Largest wins occur here (up to $38.38)
