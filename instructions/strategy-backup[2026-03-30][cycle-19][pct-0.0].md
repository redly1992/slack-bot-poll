...
- **REQUIRE FOR LONG**: bb_pos between 25% and 40% (optimal: 30-35%)
- **REQUIRE FOR SHORT**: bb_pos between 60% and 75% (optimal: 65-70%)
- **REJECT**: bb_pos < 20% or > 80% (extreme - DO NOT TRADE)
...
- **REQUIRE FOR LONG**: RSI(15m) between 38 and 45 (optimal: 40-43)
- **REQUIRE FOR SHORT**: RSI(15m) between 55 and 62 (optimal: 58-60)
- **REJECT**: RSI(15m) < 35 or > 65 (extreme - DO NOT TRADE)
...
- **REQUIRE FOR LONG**: Stochastic %K between 35 and 50 (optimal: 40-45)
- **REQUIRE FOR SHORT**: Stochastic %K between 50 and 65 (optimal: 55-60)
- **REJECT**: Stochastic %K < 30 or > 70 (extreme - DO NOT TRADE)
...
- **REJECT**: MACD hist < -80 or > 80 (extreme momentum - DO NOT TRADE)
...
- **OPTIMAL SL distance**: 2.8-3.5% (adjusted from 2.5-3.0%)
- **MINIMUM SL distance**: 2.5% (increased from 2.2%)
- **MAXIMUM SL distance**: 4.0%
- **REQUIRE**: SL distance ≥ 2.5% for confidence ≥ 70
- **RATIONALE**: Tighter stops (<2.5%) get stopped by noise in volatile crypto markets
...
- **OPTIMAL TP distance**: 5.5-7.0% (adjusted from 5.0-6.0%)
- **MINIMUM R:R ratio**: 1:2.5 (increased from 1:2.2)
- **PREFER R:R ratio**: 1:3.0 to 1:4.0
- **REQUIRE**: R:R ≥ 1:2.5 for confidence ≥ 70
...
- **HIGH QUALITY**: 98+ (requires ALL conditions met perfectly)
- **MEDIUM QUALITY**: 95-97 (minor compromises allowed)
- **LOW QUALITY**: <95 (DO NOT EXECUTE)
- **RATIONALE**: Higher confidence threshold filters out marginal setups

### 9. INDICATOR CONFLUENCE REQUIREMENT (ENHANCED)
**REQUIRE at least 8 confirming factors out of 9:**
...
6. Stochastic %K in optimal range (35-50 LONG, 50-65 SHORT) and turning
7. SL distance 2.5-4.0%
8. TP distance 5.5-7.0%
9. R:R ratio ≥ 1:2.5
- **MINIMUM**: 8 out of 9 factors must confirm for confidence ≥ 95
- **PREFER**: 9 out of 9 factors confirm for confidence ≥ 98
- **REJECT**: Less than 8 factors confirm (confidence ≤ 70)

### 10. ENTRY CHECKLIST - STRICT VERSION (CYCLE 18)
...
2. ✅ 15m EMA alignment MATCHING direction (bullish for LONG, bearish for SHORT) - MANDATORY
3. ✅ bb_pos in optimal range (25-40% for LONG, 60-75% for SHORT)
4. ✅ RSI(15m) in optimal range (38-45 for LONG, 55-62 for SHORT)
5. ✅ MACD hist in optimal range (> -50 for LONG, < 50 for SHORT) and improving
6. ✅ Stochastic %K in optimal range (35-50 for LONG, 50-65 for SHORT) and turning
7. ✅ SL distance 2.5-4.0%
8. ✅ TP distance 5.5-7.0%
9. ✅ R:R ratio ≥ 1:2.5
10. ✅ Confidence ≥ 95
...
- **High volatility (ATR > 3.5%)**: Use wider SL (3.0-4.0%), larger TP (6.0-7.0%)
- **Normal volatility (ATR 2.5-3.5%)**: Use standard SL (2.8-3.5%), TP (5.5-6.5%)
- **Low volatility (ATR < 2.5%)**: Use tighter SL (2.5-3.0%), smaller TP (5.0-5.5%)
- **Check 4H ATR** relative to price for context

### 13. TIME-BASED EXIT RULE (PRECISE)
**Exit if trade doesn't perform:**
- **Trend-following trades**: Exit if no profit within 2 candles (reduced from 3)
- **Scale out**: Take 50% profit at 3.5%, trail stop on remainder
- **Move to breakeven**: After 2.5% profit, move SL to entry + 0.5%
- **Full exit**: At 5.5% profit or if momentum reverses

### 14. RISK MANAGEMENT (ENHANCED)
**Stricter rules after 3 losses in last 3 trades:**
- **Position size**: 0.05-0.10% of portfolio per trade (reduced from 0.10-0.20%)
- **Maximum daily loss**: 0.2% of portfolio (reduced from 0.4%)
- **Stop loss placement**: Below/above structure + 2.0% minimum buffer
- **Take profit**: Primary at 5.5%, secondary at 3.5% with trail
...
1. **Reduce position size** to 0.03% maximum
2. **Increase confidence threshold** to 98+
3. **Require 9/9 confirming indicators** (instead of 8)
4. **Tighten parameter ranges** (RSI 40-43 for LONG, 58-60 for SHORT)
...
- **AVOID**: Extreme bb_pos (<25% or >75%) (all 3 losses had extreme values)
- **AVOID**: Extreme RSI(15m) (<38 or >62) (all 3 losses had extreme values)
...
- **AVOID**: Confidence < 95 (all 3 losses were ≤92 confidence)

### 18. OPTIMAL PARAMETER RANGES (PRECISE)
**Based on backtest analysis and adjustments:**
- **SL distance**: 3.0% optimal (range: 2.8-3.5%)
- **TP distance**: 6.0% optimal (range: 5.5-7.0%)
- **R:R ratio**: 1:3.0 optimal (range: 1:2.5-1:4.0)
- **bb_pos LONG**: 32% optimal (range: 30-35%)
- **bb_pos SHORT**: 68% optimal (range: 65-70%)
- **RSI(15m) LONG**: 41 optimal (range: 40-43)
- **RSI(15m) SHORT**: 59 optimal (range: 58-60)
- **Stochastic LONG**: 42 optimal (range: 40-45)
- **Stochastic SHORT**: 58 optimal (range: 55-60)
- **MACD hist LONG**: > -30 optimal (range: > -50)
- **MACD hist SHORT**: < 30 optimal (range: < 50)
...
2. ✅ bb_pos in optimal range (25-40% LONG, 60-75% SHORT)
3. ✅ RSI(15m) in optimal range (38-45 LONG, 55-62 SHORT)
4. ✅ Stochastic in optimal range (35-50 LONG, 50-65 SHORT) and turning
5. ✅ MACD hist in optimal range (> -50 LONG, < 50 SHORT) and improving
6. ✅ SL distance 2.5-4.0%
7. ✅ TP distance 5.5-7.0%
8. ✅ R:R ratio ≥ 1:2.5
9. ✅ Confidence ≥ 95
...
- bb_pos: 30-35% (moderate oversold, not extreme)
- RSI(15m): 40-43 (moderate oversold)
- Stochastic: 40-45 and rising
- MACD hist: > -30 and improving
- SL distance: ≥ 2.8%
- TP distance: ≥ 5.5%
- R:R ratio: ≥ 1:2.5
- Confidence: ≥ 95
...
- bb_pos: 65-70% (moderate overbought, not extreme)
- RSI(15m): 58-60 (moderate overbought)
- Stochastic: 55-60 and falling
- MACD hist: < 30 and deteriorating
- SL distance: ≥ 2.8%
- TP distance: ≥ 5.5%
- R:R ratio: ≥ 1:2.5
- Confidence: ≥ 95

### 21. REMOVED/REPLACED RULES FROM CYCLE 17
**Replaced these Cycle 17 rules:**
- ❌ "SL distance: 2.5-3.0%" → **REPLACED WITH** "SL distance: 2.8-3.5%"
- ❌ "TP distance: 5.0-6.0%" → **REPLACED WITH** "TP distance: 5.5-7.0%"
- ❌ "R:R ratio ≥ 1:2.2" → **REPLACED WITH** "R:R ratio ≥ 1:2.5"
- ❌ "bb_pos: 20-45% LONG, 55-80% SHORT" → **REPLACED WITH** "bb_pos: 25-40% LONG, 60-75% SHORT"
- ❌ "RSI(15m): 35-45 LONG, 55-65 SHORT" → **REPLACED WITH** "RSI(15m): 38-45 LONG, 55-62 SHORT"
- ❌ "Stochastic: 30-50 LONG, 50-70 SHORT" → **REPLACED WITH** "Stochastic: 35-50 LONG, 50-65 SHORT"
- ❌ "MACD hist: > -80 LONG, < 80 SHORT" → **REPLACED WITH** "MACD hist: > -50 LONG, < 50 SHORT"
- ❌ "Confidence threshold: 90+" → **REPLACED WITH** "Confidence threshold: 95+"

**Enhanced these Cycle 17 rules:**
...
### 22. NEW RULES FOR CYCLE 18 (BASED ON 3 LOSSES ANALYSIS)
**Added these new rules:**

1. **Stricter bb_pos Ranges (25-40% LONG, 60-75% SHORT)**
...
2. **Tighter MACD Histogram Momentum Requirement**
   - Extreme MACD hist values indicate strong momentum continuation
   - Require MACD hist > -50 for LONG, < 50 for SHORT and showing improvement

3. **Higher Confidence Threshold (95+)**
   - 40 confidence trades were clear losers
   - 92 confidence trade still lost due to rule violations
   - Require stricter filtering at confidence level

4. **Minimum SL Distance 2.5%**
   - All losing trades had SL < 2.0%
   - Crypto volatility requires wider stops to avoid noise

5. **Minimum R:R Ratio 1:2.5**
...
**Based on analysis of 3 losing trades:**
- **SL distance**: 2.8-3.5% (increase from 2.5-3.0%)
- **TP distance**: 5.5-7.0% (increase from 5.0-6.0%)
- **R:R ratio**: 1:2.5 to 1:4.0 (minimum increased)
- **Confidence threshold**: 95+ to execute (increased from 90)
- **Position size**: 0.05-0.10% of portfolio per trade (reduced)
...
3. **Check bb_pos** (must be 25-40% LONG, 60-75% SHORT - if not, STOP)
4. **Check RSI(15m)** (must be 38-45 LONG, 55-62 SHORT - if not, STOP)
5. **Check Stochastic** (must be 35-50 LONG, 50-65 SHORT and turning - if not, STOP)
6. **Check MACD hist** (must be > -50 LONG, < 50 SHORT and improving - if not, STOP)
7. **Calculate SL/TP distances** (must be in optimal ranges)
8. **Calculate R:R ratio** (must be ≥ 1:2.5)
