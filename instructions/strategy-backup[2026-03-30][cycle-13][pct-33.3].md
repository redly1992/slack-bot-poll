<!-- AI-IMPROVED: 2026-03-30 | Cycle 12 -->
...
## 📊 LEARNED RULES (Cycle 12)

### 1. 15m EMA ALIGNMENT MUST MATCH TRADE DIRECTION (CRITICAL)
**ANALYSIS**: All 3 losing trades had 15m EMA alignment OPPOSING the trade direction. This is the #1 failure pattern.
...
**ANALYSIS**: Losing trades had extreme bb_pos values (6.5%, -13.9%, 102.5%). Extreme positions indicate momentum exhaustion.
...
**ANALYSIS**: Losing trades had SL distances: 2.11%, 2.71%, 2.03%. All were hit by volatility.
...
**ANALYSIS**: Losing trades had TP distances: 4.04%, 3.50%, 4.03% with R:R ratios: 1.91, 1.29, 1.99.
...
**ANALYSIS**: Losing trades had confidence 40, 40, 40. All were low confidence trades.
...
### 10. ENTRY CHECKLIST - STRICT VERSION (CYCLE 12)
...
- **EXCEPTION**: None in Cycle 12 - pure trend-following only
...
**After 3 consecutive losses in Cycle 11:**
...
**Based on analysis of 0 wins vs 3 losses:**
- **REQUIRE**: 15m EMA alignment MUST match trade direction (bullish for LONG, bearish for SHORT)
...
- **AVOID**: 15m EMA alignment opposing trade direction (all 3 losses)
- **AVOID**: Extreme bb_pos (<30% or >70%) (all 3 losses)
- **AVOID**: Extreme RSI(15m) (<38 or >62) (all 3 losses)
- **AVOID**: Extreme Stochastic (<30 or >70) (all 3 losses)
- **AVOID**: Extreme MACD hist (<-40 or >40) (2 of 3 losses)
- **AVOID**: SL distance < 2.0% (0 of 3 losses had this, but still avoid)
...
3. **Stop loss too tight** (all 3 stopped out at 2.0-2.7%)
4. **Entering at Bollinger Band extremes** (touching bands instead of moderate zones)

## CYCLE 12 IMPROVEMENT FOCUS:
1. **STRICT 15m EMA alignment rule** - MUST match trade direction
2. **Avoid extreme indicator readings** - use precise moderate zones only
3. **Wider stops** - 2.2-2.8% minimum
4. **Higher confidence threshold** - 85+ only
5. **Stricter confluence** - 7+ confirming indicators required
6. **Better R:R ratios** - target 1:2.0 to 1:2.5 with 4.0-4.8% TP