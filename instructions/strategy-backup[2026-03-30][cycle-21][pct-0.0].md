<!-- AI-IMPROVED: 2026-03-30 | Cycle 20 -->
...
- **REJECT**: bb_pos < 15% or > 85% (extreme exhaustion - DO NOT TRADE)
...
- **REJECT**: MACD hist < -100 or > 100 (extreme momentum - DO NOT TRADE)
...
- **OPTIMAL SL distance**: 2.5-3.5% (adjusted from 2.0-3.0%)
...
- **OPTIMAL TP distance**: 5.0-7.0% (adjusted from 4.0-6.0%)
- **MINIMUM R:R ratio**: 1:2.5 (increased from 1:2.0)
...
- **MINIMUM EXECUTION CONFIDENCE**: 85 (adjusted from 80)
...
### 10. ENTRY CHECKLIST - STRICT VERSION (CYCLE 20)
...
7. ✅ SL distance 2.0-4.0%
8. ✅ TP distance 5.0-7.0%
9. ✅ R:R ratio ≥ 1:2.5
10. ✅ Confidence ≥ 85
...
- **Normal volatility (ATR 2.0-3.5%)**: Use standard SL (2.5-3.5%), TP (5.0-6.0%)
- **Low volatility (ATR < 2.0%)**: Use tighter SL (2.0-3.0%), smaller TP (4.5-5.5%)
...
- **Position size**: 0.05-0.10% of portfolio per trade (adjusted from 0.05-0.15%)
- **Maximum daily loss**: 0.2% of portfolio (adjusted from 0.3%)
...
5. ✅ MACD hist in optimal range (> -50 LONG, < 50 SHORT) and improving
6. ✅ SL distance 2.0-4.0%
7. ✅ TP distance 5.0-7.0%
8. ✅ R:R ratio ≥ 1:2.5
9. ✅ Confidence ≥ 85
...
### 21. REMOVED/REPLACED RULES FROM CYCLE 19
**Replaced these Cycle 19 rules:**
- ❌ "SL distance: 2.0-3.0%" → **REPLACED WITH** "SL distance: 2.5-3.5%"
- ❌ "TP distance: 4.0-6.0%" → **REPLACED WITH** "TP distance: 5.0-7.0%"
- ❌ "R:R ratio ≥ 1:2.0" → **REPLACED WITH** "R:R ratio ≥ 1:2.5"
- ❌ "bb_pos: 15-35% LONG, 65-85% SHORT" → **REPLACED WITH** "bb_pos: 20-40% LONG, 60-80% SHORT"
- ❌ "RSI(15m): 35-45 LONG, 55-65 SHORT" → **REPLACED WITH** "RSI(15m): 35-45 LONG, 55-65 SHORT" (maintained but stricter)
- ❌ "Stochastic: 25-45 LONG, 55-75 SHORT" → **REPLACED WITH** "Stochastic: 30-50 LONG, 50-70 SHORT"
- ❌ "MACD hist: > -100 LONG, < 100 SHORT" → **REPLACED WITH** "MACD hist: > -50 LONG, < 50 SHORT"
- ❌ "Confidence threshold: 80+" → **REPLACED WITH** "Confidence threshold: 85+"

**Enhanced these Cycle 19 rules:**
...
### 22. NEW RULES FOR CYCLE 20 (BASED ON 3 LOSSES ANALYSIS)
...
1. **Tighter MACD Histogram Momentum Requirement**
   ...
   - New range: > -50 for LONG, < 50 for SHORT
   - Extreme momentum indicates continuation, not reversal

2. **Higher R:R Ratio Requirement (1:2.5 minimum)**
   - With 0% win rate, need higher compensation for losses
   - Previous 1:2.0 insufficient given current performance
   - Target 1:3.0 optimal for profitability
...
4. **Minimum SL Distance 2.0%**
   ...
   - 2.0% minimum provides better protection

5. **Stricter Indicator Confluence (6/7 factors)**
   - Previous 5/7 allowed too many marginal setups
   - Require 6 out of 7 confirming factors
   - Ensures higher quality entries

### 23. BACKTEST-DRIVEN PARAMETERS (OPTIMIZED)
**Based on analysis of 3 losing trades:**
- **SL distance**: 2.5-3.5% (increased for better protection)
- **TP distance**: 5.0-7.0% (increased for better R:R)
- **R:R ratio**: 1:2.5 to 1:4.0 (minimum increased to 1:2.5)
...
3. **Check bb_pos** (must be 20-40% LONG, 60-80% SHORT - if not, STOP)
...
- **Patience is key** - wait for optimal